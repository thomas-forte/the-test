    ...
    <form>
        ...
        <div>
          <div class="custom-control custom-radio custom-control-inline">
            <input
              ...
              required="required"
            />
            <label for="radio1_0" class="custom-control-label">
              Yes
            </label>
          </div>
          <div class="custom-control custom-radio custom-control-inline">
            <input
              ...
              required="required"
            />
            <label for="radio1_1" class="custom-control-label">
              No
            </label>
          </div>
        </div>
          ...
          <div class="custom-controls-stacked">
            <div class="custom-control custom-radio">
              <input
                ...
                required="required"
              />
              <label for="radio2_0" class="custom-control-label">
                325 kph.
              </label>
            </div>
          </div>
          <div class="custom-controls-stacked">
            <div class="custom-control custom-radio">
              <input
                ...
                required="required"
              />
              <label for="radio2_1" class="custom-control-label">
                88 mph.
              </label>
            </div>
          </div>
          <div class="custom-controls-stacked">
            <div class="custom-control custom-radio">
              <input
                ...
                required="required"
              />
              <label for="radio2_2" class="custom-control-label">
                3 m/s.
              </label>
            </div>
          </div>
          <div class="custom-controls-stacked">
            <div class="custom-control custom-radio">
              <input
                ...
                required="required"
              />
              <label for="radio2_3" class="custom-control-label">
        ...
        <div>
          <div class="custom-control custom-radio custom-control-inline">
            <input
              ...
              required="required"
            />
            <label for="radio3_0" class="custom-control-label">
              Yes
            </label>
          </div>
          <div class="custom-control custom-radio custom-control-inline">
            <input
              ...
              required="required"
            />
            <label for="radio3_1" class="custom-control-label">
              No
            </label>
          </div>
        </div>
        ...
        <div>
          <div class="custom-control custom-radio custom-control-inline">
            <input
              ...
              required="required"
            />
            <label for="radio4_0" class="custom-control-label">
              Yes
            </label>
          </div>
          <div class="custom-control custom-radio custom-control-inline">
            <input
              ...
              required="required"
            />
            <label for="radio4_1" class="custom-control-label">
              No
            </label>
          </div>
          <div class="custom-control custom-radio custom-control-inline">
            <input
              ...
              required="required"
            />
            <label for="radio4_2" class="custom-control-label">
              I'm not sure
            </label>
          </div>
        </div>
          ...
          <div class="custom-controls-stacked">
            <div class="custom-control custom-radio">
              <input
                ...
                required="required"
              />
              <label for="radio5_0" class="custom-control-label">
          ...
          <div class="custom-controls-stacked">
            <div class="custom-control custom-radio">
              <input
                ...
                required="required"
              />
              <label for="radio5_1" class="custom-control-label">
          ...
          <div class="custom-controls-stacked">
            <div class="custom-control custom-radio">
              <input
                ...
                required="required"
              />
              <label for="radio5_2" class="custom-control-label">
          ...
          <div class="custom-controls-stacked">
            <div class="custom-control custom-radio">
              <input
                ...
                required="required"
              />
              <label for="radio5_3" class="custom-control-label">
      ...
      <div class="form-group mb-5">
        ...
        <div>
          ...
          <span id="checkboxHelpBlock" class="form-text text-muted">
        ...
        <div>
          <div class="custom-control custom-radio custom-control-inline">
            <input
              ...
              required="required"
            />
            <label for="radio6_0" class="custom-control-label">
              Yes
            </label>
          </div>
          <div class="custom-control custom-radio custom-control-inline">
            <input
              ...
              required="required"
            />
            <label for="radio6_1" class="custom-control-label">
              No
            </label>
          </div>
          <span id="radio6HelpBlock" class="form-text text-muted">
          ...
          <div class="custom-controls-stacked">
            <div class="custom-control custom-radio">
              <input
                ...
                value="beep"
              />
              <label for="radio7_0" class="custom-control-label">
                Beep
              </label>
            </div>
          </div>
          <div class="custom-controls-stacked">
            <div class="custom-control custom-radio">
              <input
                ...
                value="boop"
              />
              <label for="radio7_1" class="custom-control-label">
                Boop
              </label>
            </div>
          </div>
          <div class="custom-controls-stacked">
            <div class="custom-control custom-radio">
              <input
                ...
                value="beep-bop"
              />
              <label for="radio7_2" class="custom-control-label">
                Beep-Bop
              </label>
            </div>
          </div>
          <div class="custom-controls-stacked">
            <div class="custom-control custom-radio">
              <input
                ...
                value="idk"
              />
              <label for="radio7_3" class="custom-control-label">
        ...
        <div>
          <div class="custom-control custom-radio custom-control-inline">
            <input
              ...
              required="required"
            />
            <label for="radio8_0" class="custom-control-label">
              More
            </label>
          </div>
          <div class="custom-control custom-radio custom-control-inline">
            <input
              ...
              required="required"
            />
            <label for="radio8_1" class="custom-control-label">
              Pairs
            </label>
          </div>
          <div class="custom-control custom-radio custom-control-inline">
            <input
              ...
              required="required"
            />
            <label for="radio8_2" class="custom-control-label">
              Avenge
            </label>
          </div>
          <div class="custom-control custom-radio custom-control-inline">
            <input
              ...
              required="required"
            />
            <label for="radio8_3" class="custom-control-label">
              Orange
            </label>
          </div>
          <div class="custom-control custom-radio custom-control-inline">
            <input
              ...
              required="required"
            />
            <label for="radio8_4" class="custom-control-label">
              Animal
            </label>
          </div>
          <div class="custom-control custom-radio custom-control-inline">
            <input
              ...
              required="required"
            />
            <label for="radio8_5" class="custom-control-label">
              Hasten
            </label>
          </div>
        </div>
          ...
          <div class="custom-controls-stacked">
            <div class="custom-control custom-checkbox">
              <input
                ...
                required="required"
              />
              <label for="checkbox1_0" class="custom-control-label">
          ...
          <div class="custom-controls-stacked">
            <div class="custom-control custom-checkbox">
              <input
                ...
                required="required"
              />
              <label for="checkbox1_1" class="custom-control-label">
          ...
          <div class="custom-controls-stacked">
            <div class="custom-control custom-checkbox">
              <input
                ...
                required="required"
              />
              <label for="checkbox1_2" class="custom-control-label">
          ...
          <div class="custom-controls-stacked">
            <div class="custom-control custom-checkbox">
              <input
                ...
                required="required"
              />
              <label for="checkbox1_3" class="custom-control-label">
